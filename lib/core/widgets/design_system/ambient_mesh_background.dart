...
/// alan gradyan-mesh lekeleri + ince bir gren dokusu. BİLEREK ızgara/
/// blueprint çizgisi İÇERMEZ. Dokunuşları asla yakalamaz
/// ([IgnorePointer]); tek işi arkadaki cam yüzeylere gerçek bir ışık/doku
/// kaynağı sağlamak. Renkleri [AppGlassTokens]'tan gelir, bu yüzden açık/
/// koyu temada otomatik doğru tonu alır.
///
...
/// çizilir (`shouldRepaint` sabit false) — animasyon sadece mesh
