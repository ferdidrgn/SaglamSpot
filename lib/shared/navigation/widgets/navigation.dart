...
class _NavigationScreenState extends ConsumerState<NavigationScreen> {
  ...
  // Ortak Çıkış Onay İletişim Kutusu (Sizin signOut metodunuza reaktif bağlanır)
  Future<void> _showLogoutDialog() async {
    final bool? confirm = await showDialog<bool>(
      ...
      builder: (final context) => AlertDialog(
        ...
        content:
            const Text('Hesabınızdan güvenli bir şekilde çıkış yapılacaktır.'),
        actions: [
          TextButton(
    ...
    if (confirm ?? false)
      // Sizin kendi Notifier sınıfınız içindeki signOut fonksiyonunu çağırır
  ...
  PreferredSizeWidget _buildDesktopAppBar(final int currentIndex) => AppBar(
        backgroundColor: AppColors.background,
        elevation: 1,
        title: Row(
          children: [
            ...
            SizedBox(
                width: context.responsive(mobile: 8, tablet: 12, desktop: 16)),
            // DESKTOP REFACTOR: Masaüstü AppBar için Çıkış Butonu
            IconButton(
          ...
          child: Scaffold(
            ...
            drawer: isMobile
                ? _MobileDrawer(
                    ...
                    logo: _buildLogo(),
                    onLogoutTapped: _showLogoutDialog, // Callback gönderildi
                  )
                : null,
...
class _MobileDrawer extends StatelessWidget {
  ...
  final Widget logo;
  final VoidCallback onLogoutTapped; // Parametre eklendi
        ...
        child: SafeArea(
          child: Column(
            children: [
              ...
              const Divider(),
              // MOBILE REFACTOR: Drawer listesinin en altına çıkış butonu entegrasyonu
              ListTile(
                leading:
                ...
                onTap: () {
                  ...
                  onLogoutTapped(); // Onay penceresini tetikle
                },
              ),
              const Divider(),
        ...
        child: Column(
          children: [
            ...
            Text(
              ...
              style: TextStyle(
                fontSize:
                    context.responsive(mobile: 11, tablet: 12, desktop: 13),
                color: Colors.grey,
              ),
            ),
          ],
