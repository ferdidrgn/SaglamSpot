...
/// app_router.dart initialLocation + OnboardingCache). BEŞİNCİ SÜRÜM:
/// kullanıcının paylaştığı premium referanslara (tam ekran gerçek fotoğraf +
/// alt karartma + serif başlık + "Başla" butonu) göre yeniden inşa edildi —
/// önceki sürümün elle çizilmiş soyut mobilya sahneleri yerine artık GERÇEK
/// stok mobilya/iç mekan fotoğrafları var, marka renkleriyle (sıcak
/// espresso/amber) karartılmış bir vinyetle. Fotoğraflar sabit (kod içine
/// gömülü) Unsplash URL'leri — Firestore'a veya canlı ürün verisine hâlâ
/// BAĞLI DEĞİL, bu yüzden ilk açılışta veri henüz gelmemiş olma riski yok.
...
class _HouseWalkthroughOnboardingScreenState
  ...
  /// Her fotoğrafın yavaş, sürekli "Ken Burns" yakınlaşması — sinematik,
  /// premium bir his için. Sayfa değiştiğinde başa sarmaz, kesintisiz döngü.
  ...
  Widget build(final BuildContext context) {
    final pages = [
      (
        ...
        // Oturma grubu — vitrindeki gerçek stok fotoğraf dilinden.
            ...
            itemBuilder: (final context, final index) {
              ...
              return AnimatedBuilder(
                ...
                builder: (final context, final _) => _OnboardingPage(
                  imageUrl: imageUrl,
                  zoom: 1.0 + 0.08 * _kenBurnsController.value,
                  eyebrow: eyebrow,
                  title: title,
                  desc: desc,
                ),
...
/// Tek bir sayfa: tam ekran gerçek fotoğraf (yavaş Ken Burns yakınlaşmasıyla)
/// + marka renginde alttan yukarı karartma + üstüne oturan eyebrow/başlık/
/// açıklama. Referans görsellerdeki "INTERIOR FURNITURE / Get Started" ve
/// "Mobileri Rexhepi" ekranlarının aynı diliyle: fotoğraf ekranın tamamı,
/// metin fotoğrafın üstünde.
class _OnboardingPage extends StatelessWidget {
  ...
  Widget build(final BuildContext context) => Stack(
        ...
        children: [
          ...
          // metnin her fotoğrafta okunur kalmasını garanti eder.
          DecoratedBox(
            decoration: BoxDecoration(
