...
/// Arama sayfasının IZGARA kartı — CustomProductCard'daki asimetrik köşe/
/// camsı taban şeridi diliyle hizalandı (kullanıcının "eski tasarım daha
/// şıktı" isteğiyle geri getirildi): görsel kartın tamamını kaplıyor, isim/
/// kategori/fiyat görselin üstündeki camsı bir şeritte. Favori ve paylaş
/// burada GERÇEK işlevli kalmaya devam ediyor (CustomProductCard'ta
/// bilerek yok) — arama sonuçlarında hızlı favorileme beklenen bir
/// davranış.
