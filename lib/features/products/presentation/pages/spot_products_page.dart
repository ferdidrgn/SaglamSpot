...
class _SpotProductsPageState extends ConsumerState<SpotProductsPage> {
                    ...
                    child: Padding(
                      ...
                      child: Center(
                        child: ConstrainedBox(
                          ...
                          child:
                              _buildSearchAndFilters(context, filtered.length),
                        ),
                      ),
                    ),
                  ),
                        ...
                        child: Center(
                          child: ConstrainedBox(
                            ...
                            child: const AdsenseBanner(
                                height: 100, type: AdUnitType.multiplex),
                          ),
                        ),
                      ),
                    ),
  ...
  Widget _buildMasthead(final BuildContext context, final int totalProducts) {
    final textColumn = Column(
      ...
      children: [
        RevealFade(
          child: Text(
            context.l10n.spotHeroEyebrow,
            style: AppTextStyles.microLabel(
                fontSize: 12, letterSpacing: 3, color: const Color(0xFFE65100)),
          ),
        ),
        ...
        RevealFade(
          delayMs: 70,
          child: Text(
            context.l10n.spotHeroPageTitle,
        ...
        RevealFade(
          ...
          child: ConstrainedBox(
            constraints: BoxConstraints(
                maxWidth: context.responsive(mobile: 400, desktop: 460)),
            child: Text(
              context.l10n.spotHeroSubtitle,
              style: TextStyle(
        ...
        RevealFade(
          ...
          child: Wrap(
            ...
            children: [
              Text(context.l10n.spotHeroDealCount(totalProducts),
                  style: const TextStyle(
                      fontSize: 12.5,
                      fontWeight: FontWeight.w700,
                      color: Color(0xFF1A1A1A))),
              _dotSep(),
              _plainStat(context.l10n.spotStatNegotiable),
              _dotSep(),
              _plainStat(context.l10n.spotStatUsed),
            ],
          ),
        ),
      ],
    ...
    final showcase = RevealFade(
      ...
      child: _buildShowcaseImage(
        ...
        badgeTitle: context.l10n.spotShowcaseBadgeTitle,
        badgeSubtitle: context.l10n.spotShowcaseBadgeSubtitle,
      ...
      children: [
        ...
        Padding(
          padding: context.pagePadding.copyWith(
              top: context.responsive(mobile: 20, tablet: 28, desktop: 40),
              bottom: 0),
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
  ...
  Widget _buildShowcaseImage({
    ...
    final imageHeight =
        context.responsive(mobile: 300.0, tablet: 420.0, desktop: 520.0);
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(badgeSubtitle,
                                ...
                                overflow: TextOverflow.ellipsis,
                                style: const TextStyle(
                                    fontSize: 11, color: Color(0xFF5A5A5A))),
                          ],
                        ),
                      ),
                    ],
  ...
  Widget _dotSep() =>
      Text('•', style: const TextStyle(color: Color(0xFF9E9E9E), fontSize: 12));
  ...
  Widget _buildBreadcrumb(final BuildContext context) => Row(
        ...
        children: [
          ...
          const SizedBox(width: 6),
          Text(context.l10n.spotBreadcrumbLabel,
              style: const TextStyle(
                  fontSize: 12,
              ...
              child: Stack(
                ...
                children: [
                  ...
                  Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text(context.l10n.aphorismEyebrow,
                          style: AppTextStyles.microLabel(
                              fontSize: 11,
                              letterSpacing: 3,
                      ...
                      const SizedBox(height: 16),
                      Text(
                        context.l10n.aphorismQuote,
                        style: GoogleFonts.fraunces(
                          fontSize: context.responsive(
                              mobile: 22, tablet: 28, desktop: 34),
        ...
        children: [
          ...
          if (isDesktop) ...[
            ...
            _buildFilterButton(
              ...
              label: context.l10n.priceRangeLabel,
  ...
  // ============================================================
  // 3. SAĞ DİKEY KATEGORİ RAYI — sade, yumuşak, mobil ilhamlı liste
  // ürünlerin sağında, arama çubuğunun hemen altında başlıyor.
  // ============================================================
  // İki önceki deneme (52x52 düz ikon kutuları, sonra fotoğraf küçük-
  // resimli kutular) hem soğuk hem de kalabalık duruyordu. Artık mobil
  // uygulamadaki gibi tamamen tipografiye dayalı, görselsiz/kutusuz bir
  // liste: seçili satır ince bir turuncu vurgu çubuğu + soft (hafif
  ...
  Widget _buildRailTextItem({
    ...
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          color: isSelected
              ? SpotPalette.accent.withOpacity(0.09)
              : Colors.transparent,
    ...
    return GridView.builder(
      ...
      gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
        crossAxisCount: context.responsive(
            mobile: 2, tablet: 3, desktop: 3, largeDesktop: 4),
        crossAxisSpacing: 16,
        mainAxisSpacing: 16,
      ...
      itemBuilder: (final context, final index) {
        ...
        // (bkz. search_product_grid_card.dart). Önceden bu sayfanın
        // kendi, sol turuncu şeritli özel kartı vardı; tutarlılık için
        // kaldırıldı.
        return RevealFade(
          delayMs: (index % 8) * 45,
          offsetY: 18,
          child: SearchProductGridCard(product: products[realIndex]),
        );
      },
    );
  }
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(context.l10n.filtersSheetTitle,
                    style: const TextStyle(
                        fontSize: 11,
                        fontWeight: FontWeight.w800,
                        letterSpacing: 1.4,
                        color: Color(0xFF5A5A5A))),
                const SizedBox(height: 16),
                Text(context.l10n.priceRangeLabel,
                    style: TextStyle(
                        fontSize: 14,
                        fontWeight: FontWeight.w600,
                        color: Color(0xFF1A1A1A))),
                ...
                SizedBox(
                  ...
                  child: ElevatedButton(
                    ...
                    child: Text(context.l10n.applyFiltersButton,
                        style: const TextStyle(
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(context.l10n.priceRangeSheetTitle,
                    style: const TextStyle(
                        fontSize: 11,
                        fontWeight: FontWeight.w800,
                        letterSpacing: 1.4,
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(context.l10n.sortSheetTitle,
                  style: const TextStyle(
                      fontSize: 11,
                      fontWeight: FontWeight.w800,
                      letterSpacing: 1.4,
  ...
  String _sortLabel(BuildContext context, _SortMode mode) {
    switch (mode) {
      ...
      case _SortMode.popular:
        return context.l10n.sortPopular;
    }
  }
  ...
  Widget _buildEmptyState(final BuildContext context) => Column(
        children: [
          Icon(Icons.search_off_rounded,
              size: 44, color: const Color(0xFF9E9E9E).withOpacity(0.6)),
          const SizedBox(height: 14),
          Text(context.l10n.spotEmptyStateTitle,
              style: const TextStyle(
                  fontSize: 18,
                  color: Color(0xFF1A1A1A),
                  fontWeight: FontWeight.w600)),
          const SizedBox(height: 6),
          Text(context.l10n.spotEmptyStateSubtitle,
        ...
        child: Column(
          ...
          children: [
            Icon(Icons.error_outline_rounded,
                size: 64, color: const Color(0xFFE65100)),
            const SizedBox(height: 14),
      ...
      children: [
        GestureDetector(
          ...
          child: Icon(
            ...
            size: 20,
            color: mode == ProductViewMode.grid
                ? const Color(0xFF1A1A1A)
        ...
        GestureDetector(
          ...
          child: Icon(
            ...
            size: 20,
            color: mode == ProductViewMode.list
                ? const Color(0xFF1A1A1A)
                : const Color(0xFF9E9E9E),
          ),
        ),
